...
public class MongoDBTableCreation {
  ...
  public static void main(String[] args) throws ParseException {
		...
		db.getCollection("users").createIndex(new Document("user_id", 1), options);//1: user id 的数据是从小到大的顺序排列的
		db.getCollection("items").createIndex(new Document("item_id", 1), options);// -1:从大到小排列
