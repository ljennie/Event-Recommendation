...
//DBConnection: 不管后面用的是什么数据库，我们用的接口是同一个接口，用heritence
// add the following code into DBConnection, we’ll implement them one by one in both MySQL and MongoDB later.
